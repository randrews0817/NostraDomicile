				...
				if (json['status'] == 'True') {
					...
					if (json["zip"] == 'True') {
						...
						trace1={
						   ...
						   size:[20,50,80]},
						   mode:'markers'};
						$('#visualization_body').html('<div id="vis" style="width:600px; height:250px;"></div><div id="vis2" style="width:600px; height:250px;"></div><div id="vis3" style="width:600px; height:250px;"></div>');
